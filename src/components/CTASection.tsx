    ...
    <div className="cta-outer" id="cta">
      <div className="cta-card">
        ...
        <div className="phone-banner">
          <span className="phone-banner-q">Máte otázky?</span>
          <a href="tel:+420666888999" className="phone-chip">
          ...
          <span className="phone-hours">Po–Pá, 8:00–16:00</span>
        </div>

        {/* Main CTA row */}
        <div className="cta-body">
          <div>
            <p className="cta-eyebrow">Připraveni začít šetřit?</p>
            <h2 className="cta-title">
              Začněte šetřit s Electree<br />ještě dnes
            </h2>
            <p className="cta-sub">
              Nezávazná nabídka&nbsp;·&nbsp;Platnost do {OFFER.validity}&nbsp;·&nbsp;Přechod vyřídíme za vás
            </p>
          </div>
          ...
          <div className="cta-btns">
            ...
            {/* Secondary */}
            <a href="tel:+420666888999" className="btn-cta-ghost">
